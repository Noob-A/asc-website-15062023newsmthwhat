...
function App(props) {
  ...
  return (
    <main className="bg-slate-950 flex flex-col items-stretch">
      <header className="items-center bg-slate-950 flex w-full flex-col px-5 py-7 max-md:max-w-full">
        <nav className="flex w-full max-w-[1523px] items-stretch justify-between gap-5 max-md:max-w-full max-md:flex-wrap max-md:justify-center">
          <div className="items-stretch self-center flex gap-5 my-auto max-md:justify-center">
            ...
            <img
              ...
              alt="Image 2"
            />
            <div className="text-white text-2xl font-medium leading-6 self-center whitespace-nowrap my-auto">
              GOST
            </div>
          </div>
          <div className="items-stretch self-center flex justify-between gap-5 my-auto rounded-[40px] max-md:justify-center">
          ...
          <div className="items-stretch flex gap-4 max-md:max-w-full max-md:flex-wrap max-md:justify-center">
            <div className="justify-between items-stretch border border-[color:var(--Stock,#2A2B3A)] flex gap-2.5 px-10 py-4 rounded-[40px] border-solid max-md:px-5">
              <img
                loading="lazy"
            ...
            <button className="text-white text-base font-medium leading-4 whitespace-nowrap justify-center items-center border border-[color:var(--Stock,#2A2B3A)] grow px-5 py-4 rounded-[40px] border-solid">
              Sign In
            </button>
            <button className="text-white text-base font-medium leading-4 whitespace-nowrap justify-center items-center border-[color:var(--CTA,#4467FF)] shadow-sm grow px-5 py-4 rounded-[40px] border-[1.5px] border-solid">
              Sign Up
            </button>
          </div>
        </nav>
      </header>
      <section className="self-center flex w-full max-w-[1720px] flex-col items-center mt-1.5 mb-20 px-5 py-12 rounded-[50px] max-md:max-w-full max-md:mb-10">
        <div className="flex w-[959px] max-w-full flex-col mt-16 mb-7 max-md:mt-10">
          ...
          <div className="justify-between items-center self-center flex w-[517px] max-w-full gap-5 mt-10 max-md:flex-wrap">
            <button className="text-white text-lg font-medium leading-4 capitalize whitespace-nowrap justify-center items-center border-[color:var(--CTA,#4467FF)] shadow-sm bg-slate-950 grow my-auto px-5 py-6 rounded-[40px] border-[1.5px] border-solid">
              Contact our Sales
            </button>
            <button className="text-white text-lg font-medium leading-4 capitalize whitespace-nowrap justify-center items-center border-[color:var(--Stock,#2A2B3A)] bg-slate-950 self-stretch grow px-5 py-7 rounded-[40px] border-[1.5px] border-solid">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section
        className="backdrop-blur-[25px] bg-slate-950 bg-opacity-20 flex w-full max-w-[1520px] flex-col items-stretch mt-28 mb-24 pl-8 rounded-[42px] max-md:max-w-full max-md:my-10 max-md:pl-5"
      ...
      >
        <div className="flex w-full items-center justify-between gap-5 max-md:max-w-full max-md:flex-wrap">
          <nav className="items-stretch flex justify-between gap-5 my-auto max-md:max-w-full max-md:flex-wrap max-md:justify-center">
            <a
              href="#"
 ...
 VDB Search
          ...
          <div className="text-white text-xl font-medium leading-6 max-w-[427px] bg-slate-800 self-stretch grow px-5 py-7 rounded-[30px_30px_0px_30px] max-md:max-w-full"
              aria-label="Greeting">
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            <div className="flex flex-col items-stretch w-[61%] max-md:w-full max-md:ml-0">
              <div className="items-stretch flex flex-col max-md:max-w-full max-md:mt-10">
                <div className="text-white text-xl font-medium leading-6 max-md:max-w-full">
                  Support mode - Agent in the Agent Hub system responsible for automating technical support and guideline completely
                  <br />
                  <br />
                  This agent can integrate with DocuMentorBot, which makes it a powerful tool and allows you to provide technical support to customers through a Telegram bot
                </div>
                <div className="text-white text-xl font-medium leading-6 mt-5 max-md:max-w-full">
                  In addition, this agent is able to view images and integrate with external APIs for a more useful and efficient work as a technical support operator!
                </div>
                <div className="text-white text-xl font-medium leading-6 mt-5 max-md:max-w-full">
                  By integrating it with the Telegram bot, your clients will not only be able to interact with it via text, but they can also send attachments (pictures, documents and PDF files) and they will also be able to send voice messages
                </div>
              </div>
            </div>
            <div className="flex flex-col items-stretch w-[39%] ml-5 max-md:w-full max-md:ml-0">
              <div className="flex grow flex-col items-stretch max-md:max-w-full max-md:mt-10">
                <div className="bg-slate-950 flex items-stretch justify-between gap-2.5 pl-8 pr-20 py-7 rounded-[30px_30px_0px_0px] max-md:max-w-full max-md:flex-wrap max-md:px-5">
                  <img
                    loading="lazy"
                    ...
                    alt="Google Logo"
                  />
                  <div className="text-white text-xl font-medium leading-6 whitespace-nowrap self-start"> Browsing google.com... </div>
                </div>
                <div
                  ...
                  aria-label="Response"
                >
                  Я ваще-то не источник идей для бизнеса... Иди и пахай себе на еду, пахай да так усердно, чтобы пот из лица шел. Вот тогда у тебя бизнес взлетит... Надо ещё чего, может за тебя ещё в туалет мне сходить?
                  <br />
                  <br />
                  Короче иди давай работай, паразит! А я пошел отдыхать, потому я робот и мне всё равно.
                </div>
              </div>
            </div>
